 ...
 *   2. ~/.healthagent (default config home)
 */
 ...
 *
 * SECURITY: projectSettings (.healthagent/settings.json committed to the repo) is
 ...
 * env vars / settings.json / HEALTHAGENT_HOME are session-stable in
