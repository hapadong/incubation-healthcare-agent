...
export function checkPermissionMode(
  ...
  // Example: `Set-Location ./.healthagent; Set-Content ./settings.json '...'` — the validator
  // sees ./settings.json as /project/settings.json, but PowerShell writes to
  // /project/.healthagent/settings.json. Refuse to auto-allow any write operation in a
