...
/**
 * Loads markdown files from .healthagent/output-styles directories throughout the project
 * and from ~/.healthagent/output-styles directory and converts them to output styles.
 *
 ...
 *
 * Structure:
 * - Project .healthagent/output-styles/*.md -> project styles
 * - User ~/.healthagent/output-styles/*.md -> user styles (overridden by project styles)
 *
