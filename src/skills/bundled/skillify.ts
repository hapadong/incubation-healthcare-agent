...
- Ask where the skill should be saved. Suggest a default based on context (repo-specific workflows → repo, cross-repo personal workflows → user). Options:
  - **This repo** (\`.healthagent/skills/<name>/SKILL.md\`) — for workflows specific to this project
  - **Personal** (\`~/.healthagent/skills/<name>/SKILL.md\`) — follows you across all repos
