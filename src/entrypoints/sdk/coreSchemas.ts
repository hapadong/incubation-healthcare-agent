  ...
  z
    .object({
      ...
      memory: z
        ...
        .optional()
        .describe(
          "Scope for auto-loading agent memory files. 'user' - ~/.healthagent/agent-memory/<agentType>/, 'project' - .healthagent/agent-memory/<agentType>/, 'local' - .healthagent/agent-memory-local/<agentType>/",
        ),
      effort: z
  ...
  z
    ...
    .describe(
      'Source for loading filesystem-based settings. ' +
        "'user' - Global user settings (~/.healthagent/settings.json). " +
        "'project' - Project settings (.healthagent/settings.json). " +
        "'local' - Local settings (.healthagent/settings.local.json).",
    ),
)
