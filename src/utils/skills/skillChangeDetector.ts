...
async function getWatchablePaths(): Promise<string[]> {
  ...
  // User skills directory (~/.healthagent/skills)
  ...
  // User commands directory (~/.healthagent/commands)
  ...
  // Project skills directory (.healthagent/skills)
  ...
  // Project commands directory (.healthagent/commands)
  ...
  for (const dir of getAdditionalDirectoriesForClaudeMd()) {
    const additionalSkillsPath = platformPath.join(dir, '.healthagent', 'skills')
    try {
