// Non-React scheduler core for .healthagent/scheduled_tasks.json.
...
type CronSchedulerOptions = {
  ...
  /**
   * Directory containing .healthagent/scheduled_tasks.json. When provided, the
...
export function buildMissedTaskNotification(missed: CronTask[]): string {
  ...
  const header =
    ...
    `${plural ? 'They have' : 'It has'} already been removed from .healthagent/scheduled_tasks.json.\n\n` +
