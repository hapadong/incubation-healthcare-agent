  ...
  if (shouldAllowManagedHooksOnly()) {
    ...
    try {
      ...
      if (
        ...
        userGuidance =
          'This appears to be a permissions issue. Check file permissions on ~/.healthagent/plugins/'
      } else if (
        ...
        userGuidance =
          'This appears to be a configuration issue. Check your plugin settings in .healthagent/settings.json'
      } else {
        userGuidance =
      ...
      // from .healthagent/settings.json (loaded via captureHooksConfigSnapshot) will still work
    }
  }
