...
/**
 * Detects if a file path is a session-related file under ~/.healthagent.
 ...
 * Excludes: CLAUDE.md, CLAUDE.local.md, .healthagent/rules/*.md (user-managed).
 *
...
// Excludes CLAUDE.md, CLAUDE.local.md, .healthagent/rules/ (user-managed).
